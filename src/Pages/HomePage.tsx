      ...
      <div className="grid md:grid-cols-2 gap-10 items-center">
        <div className="animate-fadeIn">
          ...
          <p className="mt-6 text-lg md:text-xl max-w-xl" style={{ color: 'var(--text)' }}>
            Currently interning at Tesla and building Flock, a real time rideshare app used
            by hundreds of UCLA students. Background spans full stack development, systems
            programming, and applied machine learning.
          </p>
